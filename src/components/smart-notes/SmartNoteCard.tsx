...
import { Star, BookOpen, Brain, AlertTriangle, Lightbulb, Edit2, Trash2 } from "lucide-react";
...
export function SmartNoteCard({ note, index = 0, onCreateMCQ, onEdit, onDelete }: SmartNoteCardProps) {
          ...
          <div className="flex gap-2">
            ...
            {onDelete && (
              <button
                ...
                className="p-3 bg-red-500/5 hover:bg-red-500/10 text-red-600/40 hover:text-red-600 rounded-xl transition-all"
                title="Delete Note"
              >
